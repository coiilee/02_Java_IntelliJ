...
public class MemberRun {
    public static void main(String[] args) {
        ...
        //1번 같은 방법은 이름이나 성별이나 나이나 특정 조건이나.. 암호화 설정과 같은
        //특수 기능을 하나씩 작성해준 후 넣어줄 때 사용
        ...
        //필수생성자 파라미터생성자 매개변수생성자를 호출해서 감길자 50 남성 한번에 넣어줄 것
        //모든 변수명에 특정한 기능을 설정하지 않고 모두 한 번에 값을 저장할 때 사용,
        Member m2 = new Member("감길자",50,"남성");

        //m1과 m2에 각각 작성한 값들이 저장되어있는지 확인
        ...
        //toString 메서드 사용해 한번에 모든 값 출력하기
        System.out.println("toString() 메서드 기능 재사용 결과");
        //toString도 마찬가지로 return해서 값을 가지고 있을 뿐이지
